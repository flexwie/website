...
export const Hero: React.FC<HeroProps> = ({ imageData, header, subheader }) => {
  return (
    <div className='container flex flex-col sm:flex-row w-full justify-center content-center items-center pt-5'>
      <div>
      ...
      <div className='flex flex-col mr-4 ml-4 sm:m-0'>
        <h1 className='font-sans font-extrabold text-3xl text-indigo-600'>{header}</h1>
